...
<div style={{
  ...
  <div>
    <h2 style={{ fontSize: 'clamp(36px,5vw,72px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1, fontFamily: "'Biennale', sans-serif", marginBottom: '24px' }}>
      <span style={{ color: '#8A8C92' }}>Let's work</span><br />
      <span style={{ color: '#EDEAE4' }}>together.</span>
    </h2>
    <p style={{ fontSize: '14px', color: '#6B6E75', lineHeight: 1.8, marginBottom: '32px', maxWidth: '320px' }}>
    ...
    <a href="mailto:michael@devhousetech.io" style={{
      ...
      borderRadius: '8px', fontSize: '13px', fontWeight: 600, color: '#EDEAE4',
...
<div style={{
  ...
  {links.map(([label, , href]) => (
    <a key={label} href={href}
      ...
      rel="noreferrer"
      onClick={label === 'HOME' ? (e) => { e.preventDefault(); handleUp(); setTimeout(() => window.location.reload(), 950) } : handleUp}
